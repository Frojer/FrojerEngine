...
enum FE_COMPARISON_FUNC
{
	...
	FE_COMPARISON_LESS,
	FE_COMPARISON_EQUAL,
	FE_COMPARISON_LESS_EQUAL,
	FE_COMPARISON_GREATER,
	FE_COMPARISON_NOT_EQUAL,
	FE_COMPARISON_GREATER_EQUAL,
	FE_COMPARISON_ALWAYS
};
...
{
	FE_ADDRESS_MODE_WRAP,
	FE_ADDRESS_MODE_MIRROR,
	FE_ADDRESS_MODE_CLAMP,
	FE_ADDRESS_MODE_BORDER,
	FE_ADDRESS_MODE_MIRROR_ONCE
};
...
enum FE_BLEND_FLAG
{
	FE_BS_ALPHA_TO_COVERAGE_ON = 0x80000000,
	FE_BS_ALPHA_TO_COVERAGE_OFF = 0x00000000,
	FE_BS_INDEPENDENT_BLEND_ON = 0x40000000,
	FE_BS_INDEPENDENT_BLEND_OFF = 0x00000000,
	FE_BS_BLEND_ON = 0x20000000,
	FE_BS_BLEND_OFF = 0x00000000,
	FE_BS_SRC_BLEND_ZERO = 0x01000000,
	FE_BS_SRC_BLEND_ONE = 0x00000000,
	FE_BS_SRC_BLEND_SRC_COLOR = 0x02000000,
	FE_BS_SRC_BLEND_INV_SRC_COLOR = 0x03000000,
	FE_BS_SRC_BLEND_SRC_ALPHA = 0x04000000,
	FE_BS_SRC_BLEND_INV_SRC_ALPHA = 0x05000000,
	FE_BS_SRC_BLEND_DEST_ALPHA = 0x06000000,
	FE_BS_SRC_BLEND_INV_DEST_ALPHA = 0x07000000,
	FE_BS_SRC_BLEND_DEST_COLOR = 0x08000000,
	FE_BS_SRC_BLEND_INV_DEST_COLOR = 0x09000000,
	FE_BS_SRC_BLEND_SRC_ALPHA_SAT = 0x0A000000,
	FE_BS_SRC_BLEND_BLEND_FACTOR = 0x0B000000,
	FE_BS_SRC_BLEND_INV_BLEND_FACTOR = 0x0C000000,
	FE_BS_SRC_BLEND_SRC1_COLOR = 0x0D000000,
	FE_BS_SRC_BLEND_INV_SRC1_COLOR = 0x0E000000,
	FE_BS_SRC_BLEND_SRC1_ALPHA = 0x0F000000,
	FE_BS_SRC_BLEND_INV_SRC1_ALPHA = 0x10000000,
	FE_BS_DEST_BLEND_ZERO = 0x00000000,
	FE_BS_DEST_BLEND_ONE = 0x00100000,
	FE_BS_DEST_BLEND_SRC_COLOR = 0x00200000,
	FE_BS_DEST_BLEND_INV_SRC_COLOR = 0x00300000,
	FE_BS_DEST_BLEND_SRC_ALPHA = 0x00400000,
	FE_BS_DEST_BLEND_INV_SRC_ALPHA = 0x00500000,
	FE_BS_DEST_BLEND_DEST_ALPHA = 0x00600000,
	FE_BS_DEST_BLEND_INV_DEST_ALPHA = 0x00700000,
	FE_BS_DEST_BLEND_DEST_COLOR = 0x00800000,
	FE_BS_DEST_BLEND_INV_DEST_COLOR = 0x00900000,
	FE_BS_DEST_BLEND_SRC_ALPHA_SAT = 0x00A00000,
	FE_BS_DEST_BLEND_BLEND_FACTOR = 0x00B00000,
	FE_BS_DEST_BLEND_INV_BLEND_FACTOR = 0x00C00000,
	FE_BS_DEST_BLEND_SRC1_COLOR = 0x00D0000,
	FE_BS_DEST_BLEND_INV_SRC1_COLOR = 0x00E00000,
	FE_BS_DEST_BLEND_SRC1_ALPHA = 0x00F00000,
	FE_BS_DEST_BLEND_INV_SRC1_ALPHA = 0x00080000,
	FE_BS_BLEND_OP_ADD = 0x00000000,
	FE_BS_BLEND_OP_SUBTRACT = 0x00010000,
	FE_BS_BLEND_OP_REV_SUBTRACT = 0x00020000,
	FE_BS_BLEND_OP_MIN = 0x00030000,
	FE_BS_BLEND_OP_MAX = 0x00040000,
	FE_BS_SRC_BLEND_ALPHA_ZERO = 0x00001000,
	FE_BS_SRC_BLEND_ALPHA_ONE = 0x00000000,
	FE_BS_SRC_BLEND_ALPHA_SRC_COLOR = 0x00002000,
	FE_BS_SRC_BLEND_ALPHA_INV_SRC_COLOR = 0x00003000,
	FE_BS_SRC_BLEND_ALPHA_SRC_ALPHA = 0x00004000,
	FE_BS_SRC_BLEND_ALPHA_INV_SRC_ALPHA = 0x00005000,
	FE_BS_SRC_BLEND_ALPHA_DEST_ALPHA = 0x00006000,
	FE_BS_SRC_BLEND_ALPHA_INV_DEST_ALPHA = 0x00007000,
	FE_BS_SRC_BLEND_ALPHA_DEST_COLOR = 0x00008000,
	FE_BS_SRC_BLEND_ALPHA_INV_DEST_COLOR = 0x00009000,
	FE_BS_SRC_BLEND_ALPHA_SRC_ALPHA_SAT = 0x0000A000,
	FE_BS_SRC_BLEND_ALPHA_BLEND_FACTOR = 0x0000B000,
	FE_BS_SRC_BLEND_ALPHA_INV_BLEND_FACTOR = 0x0000C000,
	FE_BS_SRC_BLEND_ALPHA_SRC1_COLOR = 0x0000D000,
	FE_BS_SRC_BLEND_ALPHA_INV_SRC1_COLOR = 0x0000E000,
	FE_BS_SRC_BLEND_ALPHA_SRC1_ALPHA = 0x0000F000,
	FE_BS_SRC_BLEND_ALPHA_INV_SRC1_ALPHA = 0x00000800,
	FE_BS_DEST_BLEND_ALPHA_ZERO = 0x00000000,
	FE_BS_DEST_BLEND_ALPHA_ONE = 0x00000100,
	FE_BS_DEST_BLEND_ALPHA_SRC_COLOR = 0x00000200,
	FE_BS_DEST_BLEND_ALPHA_INV_SRC_COLOR = 0x00000300,
	FE_BS_DEST_BLEND_ALPHA_SRC_ALPHA = 0x00000400,
	FE_BS_DEST_BLEND_ALPHA_INV_SRC_ALPHA = 0x00000500,
	FE_BS_DEST_BLEND_ALPHA_DEST_ALPHA = 0x00000600,
	FE_BS_DEST_BLEND_ALPHA_INV_DEST_ALPHA = 0x00000700,
	FE_BS_DEST_BLEND_ALPHA_DEST_COLOR = 0x00000080,
	FE_BS_DEST_BLEND_ALPHA_INV_DEST_COLOR = 0x00000180,
	FE_BS_DEST_BLEND_ALPHA_SRC_ALPHA_SAT = 0x00000280,
	FE_BS_DEST_BLEND_ALPHA_BLEND_FACTOR = 0x00000380,
	FE_BS_DEST_BLEND_ALPHA_INV_BLEND_FACTOR = 0x00000480,
	FE_BS_DEST_BLEND_ALPHA_SRC1_COLOR = 0x00000580,
	FE_BS_DEST_BLEND_ALPHA_INV_SRC1_COLOR = 0x00000680,
	FE_BS_DEST_BLEND_ALPHA_SRC1_ALPHA = 0x00000780,
	FE_BS_DEST_BLEND_ALPHA_INV_SRC1_ALPHA = 0x00000040,
	FE_BS_BLEND_OP_ALPHA_ADD = 0x00000000,
	FE_BS_BLEND_OP_ALPHA_SUBTRACT = 0x00000001,
	FE_BS_BLEND_OP_ALPHA_REV_SUBTRACT = 0x00000002,
	FE_BS_BLEND_OP_ALPHA_MIN = 0x00000003,
	FE_BS_BLEND_OP_ALPHA_MAX = 0x00000004,
};
#endif