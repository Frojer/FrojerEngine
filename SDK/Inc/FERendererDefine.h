...
typedef enum FE_BIND_FLAG
{
	FE_BIND_VERTEX_BUFFER = 0x1L,
	FE_BIND_INDEX_BUFFER = 0x2L,
	FE_BIND_CONSTANT_BUFFER = 0x4L,
	FE_BIND_SHADER_RESOURCE = 0x8L,
	FE_BIND_STREAM_OUTPUT = 0x10L,
	FE_BIND_RENDER_TARGET = 0x20L,
	FE_BIND_DEPTH_STENCIL = 0x40L,
	FE_BIND_UNORDERED_ACCESS = 0x80L,
	FE_BIND_DECODER = 0x200L,
	FE_BIND_VIDEO_ENCODER = 0x400L
} 	FE_BIND_FLAG;
typedef enum FE_USAGE
{
	FE_USAGE_DEFAULT = 0,
...
typedef enum FE_PRIMITIVE_TOPOLOGY
{
