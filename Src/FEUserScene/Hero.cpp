...
void Hero::Update()
{
	...
	if (IsKeyDown(VK_LEFT))		m_pHero->GetTransform()->Rotate(FEVector3::Up * FETime::GetDeltaTime() * -90.0f);
	if (IsKeyDown(VK_RIGHT))	m_pHero->GetTransform()->Rotate(FEVector3::Up * FETime::GetDeltaTime() * 90.0f);
