...
bool FEWin32Window::InitWindow()
{
	...
	// 창을 모니터의 중앙에 오도록 합니다.
	posX = (GetSystemMetrics(SM_CXSCREEN) - m_uiWidth) / 2;
	posY = (GetSystemMetrics(SM_CYSCREEN) - m_uiHeight) / 2;
...
bool FEWin32Window::MessagePump()
{
...
LRESULT CALLBACK FEWin32Window::MsgProc(HWND i_hWnd, UINT i_uiMsg, WPARAM i_wParam, LPARAM i_lParam)
{
	switch (i_uiMsg)
	{
	case WM_KEYDOWN:
...
//
/////////////////////////////////////////////////////////////////////////
bool FEWin32Window::ResizeWindow(UINT i_width, UINT i_height)
{
	BOOL result;
