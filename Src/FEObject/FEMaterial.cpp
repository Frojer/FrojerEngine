...
//
//
//void FEMaterial::SetShader(CShader* shader)
//{
//	UINT totalSize = 0;
//	UINT scalarSize = 0;
//
...
//
//
//void FEMaterial::SetVector(UINT id, const VECTOR4& vector)
//{
...
//
//
//void FEMaterial::SetMatrix(UINT id, const MATRIX& matrix)
//{
...
//
//
//FEMaterial* FEMaterial::Find(LPCWSTR name)
//{
//	FOR_STL(_mtrlMap)
//	{
